    ...
    async def async_setup(self) -> None:
        ...
        if inverter_platform == InverterPlatform.SOLIS:
            entity_ids = {
                ...
                "solis_charge_start_hour_1": data.get(CONF_INVERTER_SOLIS_CHARGE_START_HOUR_1, DEFAULT_SOLIS_CHARGE_START_HOUR_1),
                "solis_charge_start_minute_1": data.get(CONF_INVERTER_SOLIS_CHARGE_START_MINUTE_1, DEFAULT_SOLIS_CHARGE_START_MINUTE_1),
                "solis_charge_end_hour_1": data.get(CONF_INVERTER_SOLIS_CHARGE_END_HOUR_1, DEFAULT_SOLIS_CHARGE_END_HOUR_1),
                "solis_charge_end_minute_1": data.get(CONF_INVERTER_SOLIS_CHARGE_END_MINUTE_1, DEFAULT_SOLIS_CHARGE_END_MINUTE_1),
                "solis_discharge_start_hour_1": data.get(CONF_INVERTER_SOLIS_DISCHARGE_START_HOUR_1, DEFAULT_SOLIS_DISCHARGE_START_HOUR_1),
                "solis_discharge_start_minute_1": data.get(CONF_INVERTER_SOLIS_DISCHARGE_START_MINUTE_1, DEFAULT_SOLIS_DISCHARGE_START_MINUTE_1),
                "solis_discharge_end_hour_1": data.get(CONF_INVERTER_SOLIS_DISCHARGE_END_HOUR_1, DEFAULT_SOLIS_DISCHARGE_END_HOUR_1),
                "solis_discharge_end_minute_1": data.get(CONF_INVERTER_SOLIS_DISCHARGE_END_MINUTE_1, DEFAULT_SOLIS_DISCHARGE_END_MINUTE_1),
